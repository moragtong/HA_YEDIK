...
#define DECLARE_UPDATE_UI_MAP() static const CUpdateUIBase::_AtlUpdateUIMap* GetUpdateUIMap();
#define BEGIN_UPDATE_UI_MAP(thisClass) \
	static const thisClass::CUpdateUIBase::_AtlUpdateUIMap* GetUpdateUIMap() \
	{ \
